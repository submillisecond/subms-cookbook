...
The point of this guide is **what the application observes**, not what
...
guide; the cumulative MX-bean number is good enough to tell the
story.

## What this is and isn't

The guide is **not** an end-to-end benchmark of "is ZGC faster". Pure
...
guide **is** about what the application thread sees: ZGC pauses sum
...
- `src/main/java/com/submillisecond/guides/zgc/PauseTimeBench.java`
  the bench. Warmup, heartbeat, allocator, percentile report, MX-bean
  summary.
- `src/test/java/com/submillisecond/guides/zgc/PauseTimeBenchTest.java`
