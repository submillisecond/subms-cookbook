...
"venues", aggregates, returns the best quote. The point of the guide
...
this guide exists is that with virtual threads on, the per-request
...
- `src/main/java/com/submillisecond/guides/springboot/Application.java`
  Spring Boot entry point.
- `src/main/java/com/submillisecond/guides/springboot/OrderRoutingController.java`
  the `/route` endpoint and the simulated venue call.
- `src/main/java/com/submillisecond/guides/springboot/LoadDriver.java`
  HTTP load driver with percentile reporting.
- `src/test/java/com/submillisecond/guides/springboot/OrderRoutingControllerTest.java`
