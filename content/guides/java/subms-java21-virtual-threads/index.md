...
type: guide
category: java
repoPath: guides/java/subms-java21-virtual-threads
order: 20
difficulty: 2
loc: 450
languages: [java]
...
```sh
cd cookbook/guides/java/subms-java21-virtual-threads
mvn -q package

java -cp target/classes com.submillisecond.guides.java21.VirtualThreadDemo
java -cp target/classes com.submillisecond.guides.java21.PatternMatchingDemo
java -cp target/classes com.submillisecond.guides.java21.ConcurrencyBench
java -cp target/classes com.submillisecond.guides.java21.Tests
```

Full source at [`cookbook/guides/java/subms-java21-virtual-threads`](https://github.com/stochbook/cookbook/tree/main/guides/java/subms-java21-virtual-threads).
