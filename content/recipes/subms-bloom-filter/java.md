...
5% is generous headroom; a typical run sits around 1%. The full source is at [`cookbook/recipes/subms-bloom-filter/java`](https://github.com/stochbook/cookbook/tree/main/recipes/subms-bloom-filter/java) - runnable with plain `javac` and `java`, no Maven needed.
