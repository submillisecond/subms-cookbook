...
public final class SubmillisecondBench {
    ...
    public static void main(String[] args) {
        SubMsBenchParams params = new SubMsBenchParams(80_000, 1_000, 0L);
        SubMsPerfHarness h = SubMsBench.runBench(new RateLimiterRecipe(), params);
        SubMsBench.assertP99Under(h, List.of(
            new SubMsBench.Assertion("try_acquire", ONE_MS_NS)));
        System.out.println("OK (try_acquire p99 under 1 ms)");
    }
}
