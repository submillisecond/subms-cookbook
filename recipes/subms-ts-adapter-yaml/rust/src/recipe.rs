//! `SubMsRecipe` impl - YAML encode + decode round over a representative
//! `f64` series.
...
use crate::TsYamlCodec;

pub struct YamlRecipe;

const SERIES: usize = 128;

impl SubMsRecipe for YamlRecipe {
    fn name(&self) -> &str {
    ...
    fn run(&self, h: &mut SubMsPerfHarness, params: &SubMsBenchParams) {
        ...
        h.add_meta("subms.workload.feature", "yaml-codec");
    }
}
