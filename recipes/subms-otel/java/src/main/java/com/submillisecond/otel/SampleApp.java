...
import com.submillisecond.otel.exporters.ExporterStdoutHelper;
import com.submillisecond.otel.exporters.PrometheusTextExporter;
import com.submillisecond.otel.resource.SubMsOtelResource;
 ...
 * {@code mvn -q compile exec:java -Dexec.mainClass=com.submillisecond.otel.SampleApp}
 *
 * <ul>
