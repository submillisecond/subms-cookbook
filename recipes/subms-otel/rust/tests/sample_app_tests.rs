...
use subms_otel::{OtelEventBridge, StateTransitionRecorder};

use crate::common::{InMemoryMetricExporter, sum_counter};
...
fn prometheus_scrape_carries_the_histogram() {
    ...
    use subms_otel::{PrometheusBuilder, SubMsBenchSummary, SubMsStageSummary, export_summary};
