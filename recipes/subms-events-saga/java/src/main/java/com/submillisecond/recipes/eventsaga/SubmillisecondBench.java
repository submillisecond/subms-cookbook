...
public final class SubmillisecondBench {
    ...
    public static void main(String[] args) {
        ...
        SubMsPerfHarness h = SubMsBench.runBench(new SagaRecipe(), params);
        SubMsBench.assertP99Under(h, List.of(
                new SubMsBench.Assertion("build", ONE_MS_NS),
                new SubMsBench.Assertion("commit", ONE_MS_NS),
                new SubMsBench.Assertion("compensate", ONE_MS_NS)));
        System.out.println("OK (build + commit + compensate p99 under 1 ms)");
    }
}
