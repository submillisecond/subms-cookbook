...
public final class SubmillisecondBench {
    ...
    public static void main(String[] args) {
        ...
        SubMsPerfHarness h = SubMsBench.runBench(new FillRecipe(), params);
        SubMsBench.assertP99Under(h, List.of(
                new SubMsBench.Assertion("fill_linear", ONE_MS_NS),
                new SubMsBench.Assertion("fill_locf", ONE_MS_NS)));
        System.out.println("OK (fill_linear + fill_locf p99 under 1 ms)");
    }
}
