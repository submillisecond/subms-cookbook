...
public final class SubmillisecondBench {
    ...
    public static void main(String[] args) {
        SubMsBenchParams params = new SubMsBenchParams(50_000, 1_000, 0L);
        ...
        SubMsBench.assertP99Under(h, List.of(
            ...
            new SubMsBench.Assertion("estimate", ONE_MS_NS)));
        System.out.println("OK (add + estimate p99 under 1 ms)");
    }
}
