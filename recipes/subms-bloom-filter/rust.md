...
5% is generous headroom; a typical run sits around 1%. The full crate is at [`cookbook/recipes/subms-bloom-filter/rust`](https://github.com/submillisecond/subms-cookbook/tree/main/recipes/subms-bloom-filter/rust) - `cargo test --release` runs round-trip, serialisation round-trip, and the FPR check.
